...
where t.INWHSE IN ('C','CNW')
)
SELECT a1.HOUSE,a1.ORDNO,po.INSHIN as "Ship Inst", a1.ITMSQ,a1.ITNBR,a1.ITDSC,a1.ITCLS,a1.CCUSNO,a1.CSHPNO,a1.CUSNM,a1.CUSPO,
...
FROM
(
Select  t1.HOUSE,t1.ORDNO,t1.ITMSQ,t1.ITNBR,t1.ITDSC,t1.ITCLS, t1.CCUSNO,t3.CUSNM, T1.CSHPNO, T1.RQIDT,T1.MFIDT,T1.UNMSR,t4.CUSPO,
(CASE
...
LEFT JOIN  po on po.INORNO = a1.ORDNO and po.INWHSE = a1.HOUSE
